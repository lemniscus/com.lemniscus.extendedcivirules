 ...
 */
class CRM_CivirulesConditions_Form_Contribution_PositionInRecurringSeries extends CRM_CivirulesConditions_Form_Form {
  ...
  public function buildQuickForm() {
    ...
    $this->add('text', 'ordinal_number', ts('Position of Contribution in Recurring Series'), array(), true);
